# Long Outlier Expectation Gap Harness v3

장기 투자 분석을 재현 가능한 자료·루브릭·결정론적 집계로 연결하는 provider-agnostic 하네스다.
핵심 100점 스코어카드와 Hard Veto 소유권을 유지하면서 투자 유형을 세 가지로 정리했다.
...
`non_fit`은 투자 유형이 아닌 관망·회피 시스템 상태다. **Expectation Gap은 모든 유형의 EV·AS·최종 판단에 남는 핵심 개념**이며 별도 투자 유형은 아니다. **Turnaround는 선택적 정상화 진단**이며 네 번째 유형이 아니다.
