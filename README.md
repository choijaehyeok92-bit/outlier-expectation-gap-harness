...
**신설 veto — `자사 자금으로 창출된 매출에 대한 구조적 의존`.** 위 재판정이 드러낸 구멍을 메운다.
공급자가 고객의 구매자금을 대는 구조는 기존 9개 문구 어디에도 구성요건이 없었다. 담당은 CP·FS·RT이며
판정 기준은 자금 제공 규모(반기 지분투자 / 반기 영업현금흐름)와 대상 기업향 매출 비중이다 —
10% 미만이면 cleared, 25% 초과면 confirmed, 규모는 크나 비중이 미공시면 conditional.
