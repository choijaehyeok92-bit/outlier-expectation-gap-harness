# 과제: MELI / 기준일 2026-09-17 / evidence_quality (ED)
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/MELI/reports/ED.json. 그 외 파일은 수정하지 않는다.
...
작성 후 `python harness.py validate MELI ED`로 검증한다.
