# 과제: META_REVIEW_20260921 / 기준일 2026-09-21 / red_team (RT)
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/META_REVIEW_20260921/reports/RT.json. 그 외 파일은 수정하지 않는다.
...
작성 후 `python harness.py validate META_REVIEW_20260921 RT`로 검증한다.
