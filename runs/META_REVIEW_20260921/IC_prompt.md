# 과제: META_REVIEW_20260921 / 기준일 2026-09-21 / investment_committee (IC)
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/META_REVIEW_20260921/reports/IC.json, runs/META_REVIEW_20260921/one_page_investment_record.md. 그 외 파일은 수정하지 않는다.
...
## 입력
runs/META_REVIEW_20260921/digest.md와 runs/META_REVIEW_20260921/aggregate.json (없으면 `python harness.py aggregate META_REVIEW_20260921` 후 `digest META_REVIEW_20260921` 실행). 다른 에이전트의 원 보고서는 특정 주장을 검증할 때만 해당 파일 하나를 연다.
...
작성 후 `python harness.py validate META_REVIEW_20260921 IC`로 검증한다.
