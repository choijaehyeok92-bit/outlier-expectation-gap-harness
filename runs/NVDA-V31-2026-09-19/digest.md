# Digest — NVDA-V31-2026-09-19 (as of 2026-09-19)
...
| agent | score (bear–bull) | conf | verdict | vetoes | thesis |
|---|---|---|---|---|---|
| ED | 84 (70–90) | 0.93 | support | – | 증거 품질은 강하다. 핵심 손익·현금흐름·재무상태·약정·보증·고객집중은 SEC 공시로 고정돼 있고, 정규화 팩은 원문과 QA 경고를 함께 보존한다. v3.1 조사에서 추가된 5개 CP 근거도 cutoff-valid 1차자료 중심이며 충돌·refreeze 요구가 없다. 반면 지원 대상 … |
bull: 10-K·10-Q·8-K와 정규화 재무팩이 핵심 숫자의 대부분을 직접 지지하고, v3.1 Research Orchestrator는 cutoff·충돌·fact/estimate를 분리한다. 새 CP 근거 5건도 1차자료 중심이고 verified fact conflict가 없다. / bear: 핵심 투자질문인 지원 대상 고객의 매출·AR 비중, $105B 보증의 확률가중 손실·보상 경제성, 고객 AI 인프라 ROI는 회사가 공개하지 않는다. 강한 원자료 품질과 별개로 이 공백은 최종 판단의 불확실성을 남긴다.
unknowns: 투자·AI-cloud 약정·보증 대상 고객의 총매출 및 AR 비중. · $108.5B maximum gross guarantees의 확률가중 기대손실·phase별 활성액·회수율.

## red_team
| agent | score (bear–bull) | conf | verdict | vetoes | thesis |
|---|---|---|---|---|---|
| RT | 50 (30–70) | 0.93 | oppose | V1=cleared, V2=cleared, V4=cleared, V5=cleared, V6=cleared, V7=cleared, V8=cleared | 가장 강한 반대 논리는 회계부정이나 지급불능이 아니라 'AI 수요의 일부가 NVIDIA 자본·cloud 약정·보증으로 촉진되고 있으며 시장은 이를 자생적 고마진 성장으로 과대평가할 수 있다'는 것이다. 현재가 $222.27는 Base $212.86보다 높고 Bear $74.99까지 하… |
bull: 단기 실적과 현금창출은 공매도 논리를 강하게 반박한다. Q2 매출 +105.9%, gross margin 75%, TTM OCF $134.4B, 순현금 $23.2B이며 $105B 보증은 조건부·단계적이고 회수장치가 있다. / bear: 가장 취약한 고리는 AI 인프라 수요의 자생성과 가격이다. $36B AI-cloud 약정, $108.5B gross 보증, $93.9B 지분투자와 DSO 60일이 동시에 존재한다. Base 가치보다 높은 현재가에서 수요 정상화와 고객 신용악화가 겹치면 큰 멀티플·FCF 압축이 가능하다.
unknowns: 투자·보증·AI-cloud 지원 대상 고객의 총매출 및 AR 비중. · $108.5B gross guarantees의 확률가중 손실·phase별 활성액·회수율과 OpenAI 보상 경제성.

## macro_overlay
| agent | score (bear–bull) | conf | verdict | vetoes | thesis |
|---|---|---|---|---|---|
| MO | 45 | 0.9 | neutral mult=0.5 | – | 금융여건은 높은 실질금리와 9월 FOMC의 25bp 인상으로 제약적이지만 HY OAS 270bp로 신용경색은 아니다. 지정학이 더 강한 제약이다. Hormuz·Bab el-Mandeb 통항이 정상 이하이고 Brent가 9월 15일 $130.80까지 상승했다. 무역·수출통제·제재도 지속… |
unknowns: Hormuz/Bab el-Mandeb 통항과 중동 에너지 인프라가 언제 정상화되는가. · 고유가가 미국 물가와 후속 통화정책에 얼마나 전이되는가.
