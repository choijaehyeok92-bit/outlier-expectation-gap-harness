# 과제: NVDA-V31-2026-09-19 / 기준일 2026-09-19 / evidence_quality (ED)
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/NVDA-V31-2026-09-19/reports/ED.json. 그 외 파일은 수정하지 않는다.
...
작성 후 `python harness.py validate NVDA-V31-2026-09-19 ED`로 검증한다.
