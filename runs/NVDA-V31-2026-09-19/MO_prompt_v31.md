# 과제: NVDA-V31-2026-09-19 / 기준일 2026-09-19 / macro_overlay (MO)
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/NVDA-V31-2026-09-19/reports/MO.json. 그 외 파일은 수정하지 않는다.
...
작성 후 `python harness.py validate NVDA-V31-2026-09-19 MO`로 검증한다.
