# 과제: ALAB / 기준일 2026-09-18 / financial_preprocessor (FP) — Stage 0
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/ALAB/sources/financials/normalized_financials.json. 그 외 파일은 수정하지 않는다.
웹 검색을 하지 않는다. 사용자가 직접 제공한 공시·감사재무제표·IR 문서만 사용한다.

## Stage 0 문서 확보 현황
문서 11건, 요건 충족 5/11.
- [OK ] latest_annual · required · 2/1 — 최근 10-K / 최근 사업보고서
...
- [GAP] historical_annuals · strongly_recommended · 2/3 — 과거 3~5개년 10-K / 과거 3~5개년 사업보고서
...
## 출력 계약
스키마: schemas/financial_pack.schema.json. 검증: python harness.py validate-pack ALAB
