# 과제: IOT / 기준일 2026-09-18 / red_team (RT)
저장소: /workspace/scratch/b9dcb49326cf/repo. 작성할 파일: runs/IOT/reports/RT.json. 그 외 파일은 수정하지 않는다.
...
작성 후 `python harness.py validate IOT RT`로 검증한다.
