# 과제: IOT / 기준일 2026-09-18 / expectation_valuation (EV)
저장소: /workspace/scratch/b9dcb49326cf/repo. 작성할 파일: runs/IOT/reports/EV.json. 그 외 파일은 수정하지 않는다.
...
## 독립성
runs/IOT/reports/의 다른 에이전트 보고서는 읽지 않는다.
...
## 결정론적 밸류에이션
{
  ...
  "locked_context": {
    "current_price": 39.55,
    "net_cash_per_share": 2.2451978561663806,
...
작성 후 `python harness.py validate IOT EV`로 검증한다.
