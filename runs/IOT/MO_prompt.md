# 과제: IOT / 기준일 2026-09-18 / macro_overlay (MO)
저장소: /workspace/scratch/b9dcb49326cf/repo. 작성할 파일: runs/IOT/reports/MO.json. 그 외 파일은 수정하지 않는다.
...
작성 후 `python harness.py validate IOT MO`로 검증한다.
