# 과제: PYPL / 기준일 2026-09-18 / disruptive_innovation (DI)
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/PYPL/reports/DI.json. 그 외 파일은 수정하지 않는다.
...
## 기업 기준 정보 (재검증 금지)
{"ticker":"PYPL","company_name":"PayPal Holdings, Inc.","as_of_date":"2026-09-18","currency":"USD","current_price":52.41,"shares_diluted":855460874,"market_cap_usd":44835000000,"enterprise_value":42970000000,"portfolio_context":{"existing_position_pct":0,"sector_exposure_pct":0},"known_sources":["User-uploaded PayPal FY2025 Form 10-K filed 2026-02-03","User-uploaded PayPal Q1 FY2026 Form 10-Q filed 2026-05-05","User-uploaded PayPal Q2 FY2026 Form 10-Q and 8-K filed 2026-07-28","2026-09-18 close $52.41 from historical market data","StockResearch PYPL valuation: 5Y weekly TTM P/E 12th percentile, updated 2026-08-22","FinanceCharts PYPL PE: 9.89x on 2026-09-18 vs 5Y average 18.31x"],"special_questions":["Is branded checkout stabilization enough to stop structural wallet-share erosion versus Apple Pay, Shop Pay, Stripe and card-network tokenized checkout?","Can Venmo, Braintree and financial-services monetization restore transaction-margin-dollar growth without sacrificing margin?","Do aggressive buybacks at depressed valuation create durable per-share compounding despite modest top-line growth?"],"net_cash_per_share":2.18,"valuation_percentile_5y":0.12,"valuation_metric":"TTM P/E percentile over trailing 5-year weekly observations; latest reproducible pre-as-of reading 12th percentile. Cross-check: 2026-09-18 PE 9.89x vs 5Y average 18.31x.","valuation_overrides":{"terminal_multiples":{}}}

## 검증된 1차 자료 사실
# PYPL frozen source bundle — as of 2026-09-18

## Frozen market/model inputs
- 2026-09-18 close: **$52.41**.
- Shares outstanding: **855.461M** as of 2026-07-22.
- Market cap: **~$44.84B**.
- Q2 cash, cash equivalents and investments: **$15.3B**.
- Q2 debt: **$13.4B**.
- Frozen net cash: **~$1.9B**; net_cash_per_share **$2.18**.
- 5Y valuation percentile: **0.12 (12th percentile)** using weekly TTM P/E observations; latest reproducible reading updated 2026-08-22.
- 2026-09-18 TTM P/E: **~9.89x** vs 5Y average **~18.31x**.
- Required return **9%**, horizon **10 years**, terminal multiples **15x / 20x / 25x**.
- Owner-FCF/share paths:
  - Bear: 4.0, 3.8, 4.0, 4.2, 4.4, 4.6, 4.8, 5.0, 5.2, 5.4
  - Base: 5.0, 5.4, 5.9, 6.4, 7.0, 7.6, 8.2, 8.8, 9.4, 10.0
  - Bull: 5.5, 6.2, 7.0, 7.8, 8.8, 9.8, 10.8, 11.8, 12.8, 13.8
- Locked DCF: Bear **$64.74**, Base **$131.42**, Bull **$204.22**.
- price/Base: **~0.399**.
- Bull/current: **~3.90x**.
- Bear/current: **~1.24x**.

## FY2025 10-K
- Revenue **$33.172B**, +4% y/y.
- Operating income **$6.065B**, +14%.
- Operating margin **18%** vs 17% in 2024.
- Net income **$5.233B**, +26%.
- Diluted EPS **$5.41**, +35%.
- OCF **$6.416B**.
- Capex **$852M**.
- SBC **$1.002B**.
- Owner-style FCF proxy (OCF - capex - SBC): **$4.562B**.
- TPV **$1.79T**, +7%.
- Active accounts **439M**, +1%.
- Repurchased **86M shares for $6.053B**.
- Shares outstanding **920.665M** as of 2026-01-28.
- No financial-statement correction/restatement flag.

## Q2 / H1 2026
- Q2 revenue **$8.682B**, +5%.
- H1 revenue **$17.035B**.
- Q2 GAAP operating income **$1.427B**, -5%; operating margin **16.4%**.
- H1 operating income **$2.915B**.
- Q2 GAAP EPS **$1.25**, -3%.
- Q2 TPV **$486.4B**, +10%; payment transactions +8%.
- Active accounts **439M**, +0.3% y/y and essentially flat sequentially.
- Q2 transaction margin dollars **$3.9B**, +1%; excluding interest on customer balances **$3.619B**, +3%.
- H1 OCF **$3.117B**.
- H1 capex **$439M**.
- H1 SBC **$585M**.
- H1 owner-style FCF proxy **$2.093B**.
- Q2 company FCF **$1.775B**.
- Q2 cash + investments **$15.3B**; debt **$13.4B**.
- Q2 repurchased **~33M shares for $1.5B**; trailing 12 months repurchased **~111M shares for $6.0B**.
- Shares outstanding fell to **855.461M** by 2026-07-22.
- Management stated branded checkout had further stabilized; Venmo and Braintree momentum remained strong and the company was diversifying through financial services.
- FY2026 non-GAAP EPS guidance raised to **~$5.38**; GAAP EPS guidance remained a mid-single-digit decline versus $5.41 in 2025.

## Valuation context
- StockResearch: TTM P/E at **12th percentile** of trailing 5-year weekly observations, current reading around 11.6x at its latest update vs 5Y median 18.3x.
- FinanceCharts on 2026-09-18: TTM P/E **9.89x**, 5Y average **18.31x**.

공시 원문: runs/PYPL/sources/*.txt — runs/PYPL/sources/INDEX.md의 섹션 줄번호로 grep·부분 읽기만 한다.

## 독립성
runs/PYPL/reports/의 다른 에이전트 보고서는 읽지 않는다.
...
작성 후 `python harness.py validate PYPL DI`로 검증한다.
