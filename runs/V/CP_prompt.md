# 과제: V / 기준일 2026-09-18 / customer_product (CP)
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/V/reports/CP.json. 그 외 파일은 수정하지 않는다.
...
작성 후 `python harness.py validate V CP`로 검증한다.
