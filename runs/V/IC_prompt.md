...
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/V/reports/IC.json, runs/V/one_page_investment_record.md. 그 외 파일은 수정하지 않는다.
