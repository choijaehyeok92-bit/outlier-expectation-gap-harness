# 과제: V / 기준일 2026-09-18 / structural_leadership (SL)
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/V/reports/SL.json. 그 외 파일은 수정하지 않는다.
...
## 고정 채점 루브릭
{
  ...
  "domain": {
    "criteria": [
      {
        "id": "secular_durability",
        "weight": 0.4,
        "question": "구조 변화의 5~10년 지속성",
        "anchors": {
          "25": "사이클 중심",
          "50": "구조·사이클 혼재",
          "75": "장기 수요/지불의사 확인",
      ...
      {
        "id": "category_leadership",
        "weight": 0.35,
        "question": "경쟁기준·표준·배포 리더십",
        "anchors": {
          "25": "추종자",
          "50": "유의미 참여자",
          "75": "리더십 입증",
      ...
      },
      {
        ...
        "observable_anchors": {
          "metric": "수요 동인이 서로 독립적인 최종시장 중 매출 10% 이상을 차지하는 것의 개수",
          "table": [
            {
              "test": "0개 — 단일 수요 동인이 매출의 80% 이상",
              "score": 45
            },
            {
              "test": "1개",
          ...
          "modifiers": [
            "실현된 최대 단일 리스크(규제·수출통제·대형 고객 이탈)를 매출 감소 없이 흡수한 이력이 1차 자료로 확인되면 +10 (상한 90)"
          ]
        }
      }
    ]
