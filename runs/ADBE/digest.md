...
bull: A rerating can occur if AI monetization proves durable, but that is a growth/expectation-gap thesis. / bear: If AI disruption worsens, the business could de-rate further, but that still does not make the current state a classic turnaround.
unknowns: Long-run AI monetization per user, Firefly inference economics, and how much AI-first ARR…
