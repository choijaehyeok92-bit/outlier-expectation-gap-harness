# 과제: ADBE / 기준일 2026-09-18 / disruptive_innovation (DI)
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/ADBE/reports/DI.json. 그 외 파일은 수정하지 않는다.
...
- H1 revenue **$13.016B** vs $11.587B.
- Q2 operating income **$2.238B**; H1 **$4.656B**.
- H1 net income **$3.601B**.
- Total Adobe ARR **$27.10B**, +12.5% y/y, including ~$480M from Semrush.
- Q2 customer-group subscription revenue **$6.39B**, +14%.
- Creative & Marketing Professionals subscription revenue **$4.54B**, +13%.
- Business Professionals & Consumers subscription revenue **$1.85B**, +16%.
- RPO **$22.27B**, with ~67% expected within 12 months.
- H1 OCF **$5.123B**.
- H1 PP&E purchases **$95M**.
- H1 SBC recognized in equity **$1.043B**.
- H1 repurchases **$4.589B**.
- Cash + short-term investments **$5.626B**; total debt **$6.645B**.

## Q3 FY2026 earnings release
- Revenue **$6.76B**, +13% y/y.
- Total Adobe ARR **$27.50B**.
- AI-first ARR grew **>150% y/y**.
- Adobe reported **>1 billion MAU** across creativity and productivity.
- Q3 GAAP operating income **$2.354B**; net income **$1.83B**.
- Q3 OCF **$2.52B**.
- RPO **$22.16B**; cRPO 67%.
- Approximately **9.5M shares** repurchased in Q3.
- FY2026 revenue target raised to **$26.576B-$26.626B**.
- Ending ARR growth target **10.2% y/y**.
- Q4 revenue target **$6.80B-$6.85B**.
- CEO transition: Anil Chakravarthy to become CEO Dec. 1, 2026; Shantanu Narayen to Executive Chair.

공시 원문: runs/ADBE/sources/*.txt — runs/ADBE/sources/INDEX.md의 섹션 줄번호로 grep·부분 읽기만 한다.

## 독립성
runs/ADBE/reports/의 다른 에이전트 보고서는 읽지 않는다.
...
작성 후 `python harness.py validate ADBE DI`로 검증한다.
