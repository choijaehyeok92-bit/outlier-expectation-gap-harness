# 과제: ADBE / 기준일 2026-09-18 / expectation_valuation (EV)
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/ADBE/reports/EV.json. 그 외 파일은 수정하지 않는다.
...
작성 후 `python harness.py validate ADBE EV`로 검증한다.
