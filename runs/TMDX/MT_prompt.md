# 과제: TMDX / 기준일 2026-09-18 / moat_trajectory (MT)
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/TMDX/reports/MT.json. 그 외 파일은 수정하지 않는다.
    ...
    "criteria": [
      ...
      },
      {
        ...
        "observable_anchors": {
          ...
          "interpolation": {
            "mode": "none",
            "reason": "1차 자료 수치의 개수와 추세·전환비용 충족 여부(이산). 보간하면 확보하지 못한 관측치를 있는 것처럼 만든다."
          }
        }
      },
      {
...
작성 후 `python harness.py validate TMDX MT`로 검증한다.
