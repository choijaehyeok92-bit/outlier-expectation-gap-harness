# 과제: TMDX / 기준일 2026-09-18 / structural_leadership (SL)
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/TMDX/reports/SL.json. 그 외 파일은 수정하지 않는다.
    ...
    "criteria": [
      ...
      },
      {
        ...
        "observable_anchors": {
          ...
          "interpolation": {
            "mode": "none",
            "reason": "최종시장 개수(이산). 개수 사이의 값은 존재하지 않는다."
          }
        }
      }
    ]
...
작성 후 `python harness.py validate TMDX SL`로 검증한다.
