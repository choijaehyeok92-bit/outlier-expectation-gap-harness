# 과제: TMDX / 기준일 2026-09-18 / financial_preprocessor (FP) — Stage 0
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/TMDX/sources/financials/normalized_financials.json. 그 외 파일은 수정하지 않는다.
...
## 출력 계약
스키마: schemas/financial_pack.schema.json. 검증: python harness.py validate-pack TMDX
