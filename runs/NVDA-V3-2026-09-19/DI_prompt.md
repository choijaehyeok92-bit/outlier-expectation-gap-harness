# 과제: NVDA-V3-2026-09-19 / 기준일 2026-09-19 / disruptive_innovation (DI)
저장소: 현재 저장소 루트. 작성할 파일: runs/NVDA-V3-2026-09-19/reports/DI.json. 그 외 파일은 수정하지 않는다.
...
작성 후 `python harness.py validate NVDA-V3-2026-09-19 DI`로 검증한다.
