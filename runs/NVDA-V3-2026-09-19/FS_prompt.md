# 과제: NVDA-V3-2026-09-19 / 기준일 2026-09-19 / financial_survival (FS)
저장소: 현재 저장소 루트. 작성할 파일: runs/NVDA-V3-2026-09-19/reports/FS.json. 그 외 파일은 수정하지 않는다.
...
작성 후 `python harness.py validate NVDA-V3-2026-09-19 FS`로 검증한다.
