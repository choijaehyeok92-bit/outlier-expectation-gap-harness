# 과제: MSFT / 기준일 2026-09-17 / financial_survival (FS)
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/MSFT/reports/FS.json. 그 외 파일은 수정하지 않는다.
...
작성 후 `python harness.py validate MSFT FS`로 검증한다.
