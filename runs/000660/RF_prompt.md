# 과제: 000660 / 기준일 2026-09-17 / reinvestment_fcf (RF)
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/000660/reports/RF.json. 그 외 파일은 수정하지 않는다.
...
작성 후 `python harness.py validate 000660 RF`로 검증한다.
