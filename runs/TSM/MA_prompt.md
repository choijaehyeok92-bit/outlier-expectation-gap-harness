# 과제: TSM / 기준일 2026-09-18 / management_allocation (MA)
저장소: /home/runner/work/outlier-expectation-gap-harness/outlier-expectation-gap-harness. 작성할 파일: runs/TSM/reports/MA.json. 그 외 파일은 수정하지 않는다.
...
작성 후 `python harness.py validate TSM MA`로 검증한다.
