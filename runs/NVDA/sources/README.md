...
Use `runs/NVDA/sources/INDEX.md` line numbers; do not read a filing whole.
...
- NASDAQ close 2026-09-17: **$219.34** (StockAnalysis / Investing.com, observed 2026-09-18).
- Derived from filings at that close: market cap = 219.34 × 24,285M diluted = $5,326.7B;
  net cash 23,220 → EV ≈ $5,303.5B.
- TTM (Q3 FY26 + Q4 FY26 + Q1 FY27 + Q2 FY27) from the tables above: revenue 302,970; net income 192,880;
  ...
  → trailing P/E 27.6x, P/FCF 41.9x, owner FCF (FCF − SBC) 119,765 = $4.92 per diluted share.
