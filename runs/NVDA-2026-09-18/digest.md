# Digest — NVDA-2026-09-18 (as of 2026-09-18)
score 70.19 (ex-val 73.22, Emerging Outlier) · DI 78.75 · TQ None · archetype growth — Highest eligible deterministic fit; ties use configured priority · veto CLEARED · state NORMAL_CANDIDATE
signals {'price_to_base_value': 1.0442, 'valuation_percentile_5y': 0.05, 'revenue_cagr_next_3y': 0.29, 'market_cap_usd': 5367153690000.0} · reachable(raw) ['growth']
...
|---|---|---|---|---|---|
| SL | 75.5 (55–88) | 0.75 | support | – | 가속 컴퓨팅의 구조 변화는 실재하고 NVIDIA는 카테고리 기준을 정의한다. CUDA 개발자 750만명, 앱 6,000개, TOP500 78%, 누적 R&D $76.7B와 연간 아키텍처 cadence가 이를 뒷받침한다. Q2 FY27 Data Center +117%와 75% gross… |
...
## customer_product — 70.25 (raw 70.25, spread 35.0, DISPUTE)
| agent | score (bear–bull) | conf | verdict | vetoes | thesis |
|---|---|---|---|---|---|
| CP | 70.25 (50–85) | 0.78 | support | V4=cleared, V8=cleared | 고객가치와 사용 확대는 강하다. 새 1차자료는 $36B AI-cloud 약정이 제3자 사용으로 줄고 qualifying revenue share가 가능하며, $105B PORTS-Pike 보증도 OpenAI의 특정 default 때만 발동하고 재임대·매각 등 회수장치와 별도 OpenA… |
bull: Q2 매출 $96.2B, gross margin 75.0%, H1 고객 선수금 $15.6B와 Hyperscale·ACIE의 100%+ 성장은 강한 지불의사와 사용 확대를 지지한다. AI-cloud capacity의 제3자 전환·revenue share와 보증 회수장치도 gross ex… / bear: 지원 대상 고객의 총매출·AR 비중과 OpenAI의 보증 보상 경제성은 여전히 미공개다. DSO도 45일에서 60일로 상승했다. 따라서 $36B AI-cloud 약정과 $105B residual-value 보증이 수요를 얼마나 보조하는지 완전히 분리할 수 없다.
unknowns: 지분투자·AI-cloud agreements·보증 대상 기업에서 발생한 매출 및 AR 비중. · OpenAI의 NVIDIA 보증 보상 금액·수익률·담보와 9개 phase별 실제 보증 cap.
...
## long_term_growth — 77.5 (raw 77.5, spread 40.0, DISPUTE)
| agent | score (bear–bull) | conf | verdict | vetoes | thesis |
|---|---|---|---|---|---|
| LG | 77.5 (50–90) | 0.72 | neutral | – | 5년 기회 규모와 조직 적응력은 최상위권이고 5~10년 성장 지속도 타당하다. 그러나 가격/Base 1.044와 이미 높은 시장 기대, 지원 대상 매출·AR 비중의 미공개 때문에 구체적이고 반증 가능한 시장 과소평가를 입증하지 못한다. LTG 총점은 77.5지만 market_mispe… |
bull: AI compute 수요가 추론·에이전트·로보틱스로 확장되고 CUDA·NVLink·네트워킹·소프트웨어가 함께 성장하면 5년 3배 규모와 10년 활주로가 가능하다. 게임 GPU에서 데이터센터 플랫폼으로 전환한 조직의 재창조 실적도 강하다. / bear: 현재 가격은 이미 Base 가치를 소폭 웃돌고 AI 리더십이 널리 알려져 있다. 고객 집중, custom ASIC, 중국 접근 제한, 대규모 고객지원·보증이 장기 성장의 질과 시장 기대오류를 약화시킨다.
unknowns: Supported customers share of revenue and accounts receivable. · Independent Rubin cost per token versus leading custom ASICs.

## evidence_quality
| agent | score (bear–bull) | conf | verdict | vetoes | thesis |
|---|---|---|---|---|---|
| ED | 88 | 0.94 | support | – | 핵심 투자판단 수치는 대부분 cutoff-valid SEC 10-K/10-Q와 frozen 재무팩에 직접 연결된다. v3.1 Research Orchestrator가 보증·AI-cloud 약정의 조건과 완화장치를 원문에서 추가 확인해 CP의 성장주 게이트 판단 근거도 강화됐다. 다만 … |
unknowns: 지분투자·AI-cloud·보증 대상 고객향 매출과 AR의 정확한 비중. · 고객 AI 인프라의 실현 ROI와 가동률.

## red_team
| agent | score (bear–bull) | conf | verdict | vetoes | thesis |
|---|---|---|---|---|---|
| RT | 50 | 0.94 | oppose | V1=cleared, V2=cleared, V4=cleared, V5=cleared, V6=cleared, V7=cleared, V8=cleared | 가장 강한 공매도 논리는 'AI 수요 붕괴' 자체보다 수요의 질과 가격이다. NVIDIA는 $5T+ 시가총액에서 Base 가치보다 약간 높은 가격에 거래되고, $279B 공급·용량 약정, $36B AI-cloud 약정, $108.5B 최대 보증 노출과 급증한 AR을 동시에 안고 있다.… |
unknowns: 지원·보증 대상 고객이 전체 매출과 AR에서 차지하는 정확한 비중. · 고객 AI 인프라의 장기 가동률과 실제 투자수익률.
...
| agent | score (bear–bull) | conf | verdict | vetoes | thesis |
|---|---|---|---|---|---|
| IC | 70.19 | 0.91 | support | – | v3.2에서 NVDA는 Growth 적격이다. LTG는 77.5점이지만 market_misperception 50이 Outlier Growth 하한 65에 못 미친다. 모든 Hard Veto는 cleared지만 현재가 $222.27가 Base $212.86을 약 4.4% 상회하고 Be… |
