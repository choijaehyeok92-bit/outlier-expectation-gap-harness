# 과제: NVDA-2026-09-18 / 기준일 2026-09-18 / expectation_valuation (EV)
저장소: /workspace/scratch/b9dcb49326cf/repo. 작성할 파일: runs/NVDA-2026-09-18/reports/EV.json. 그 외 파일은 수정하지 않는다.
...
공시 원문: runs/NVDA-2026-09-18/sources/*.txt — runs/NVDA-2026-09-18/sources/INDEX.md의 섹션 줄번호로 grep·부분 읽기만 한다.

## 독립성
runs/NVDA-2026-09-18/reports/의 다른 에이전트 보고서는 읽지 않는다.
...
작성 후 `python harness.py validate NVDA-2026-09-18 EV`로 검증한다.
