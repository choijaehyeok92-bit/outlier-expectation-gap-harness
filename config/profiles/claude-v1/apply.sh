...
echo "claude-v1 profile applied."
...
echo
echo "NOTE: 'python harness.py selftest' will FAIL under this profile until you apply"
echo "      selftest-config-driven.patch — the selftest hardcodes the \$20B moonshot cap"
echo "      that this profile raises to \$50B. Apply with:"
echo "        git apply config/profiles/claude-v1/selftest-config-driven.patch"
